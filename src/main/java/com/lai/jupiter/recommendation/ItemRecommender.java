...
/* when the user is not logged in. The recommendation is purely based-on top games returned by Twitch. */
...
public class ItemRecommender {
    ...
    /* Besides recommendByTopGames, let’s implement another method recommendByFavoriteHistory to recommend based-on favorite history. */
